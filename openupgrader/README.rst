...
.. |badge3| image:: https://img.shields.io/badge/github-efatto%2Fopenupgrader-lightgray.png?logo=github
    :target: https://github.com/efatto/openupgrader/tree/18.0/openupgrader
...
.. image:: https://raw.githubusercontent.com/efatto/openupgrader/18.0/openupgrader/static/description/menu.png
    :alt: Menu

Which provides two rows: the OpenUpgrader Migration is used to manage the migration process:

.. image:: https://raw.githubusercontent.com/efatto/openupgrader/18.0/openupgrader/static/description/migration.png
    :alt: Migration
...
.. image:: https://raw.githubusercontent.com/efatto/openupgrader/18.0/openupgrader/static/description/configuration.png
    :alt: Configuration
...
.. image:: https://raw.githubusercontent.com/efatto/openupgrader/18.0/openupgrader/static/description/import_yml.png
    :alt: Import yml file
...
.. image:: https://raw.githubusercontent.com/efatto/openupgrader/18.0/openupgrader/static/description/create_recreate_venv.png
...
.. image:: https://raw.githubusercontent.com/efatto/openupgrader/18.0/openupgrader/static/description/pip_requirements.png
    :alt: Pip Requirements

* SQL commands: some command to be executed before of after the migration:

.. image:: https://raw.githubusercontent.com/efatto/openupgrader/18.0/openupgrader/static/description/sql_commands.png
    :alt: SQL commands

* Modules management: in this menu is possible to add module to be installed automatically, unistalled, or simply deleted:

.. image:: https://raw.githubusercontent.com/efatto/openupgrader/18.0/openupgrader/static/description/modules_management.png
    :alt: Modules management

* Installed modules: this menu is auto-computed at the creation of the configuration:

.. image:: https://raw.githubusercontent.com/efatto/openupgrader/18.0/openupgrader/static/description/installed_modules.png
...
`feedback <https://github.com/efatto/openupgrader/issues/new?body=module:%20openupgrader%0Aversion:%2018.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `efatto/openupgrader <https://github.com/efatto/openupgrader/tree/18.0/openupgrader>`_ project on GitHub.
