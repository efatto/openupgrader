...
class OpenUpgrader(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_openupgrader(self):
        ...
        openupgrader_migration.button_update_current_version()
        openupgrader_migration.start_odoo(openupgrader_migration.current_version_id)
        openupgrader_migration.install_uninstall_module("l10n_it_account")
        openupgrader_migration.button_stop_odoo()
